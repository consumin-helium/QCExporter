...
class VMT_OT_MakeVTF(Operator):
    ...
    def execute(self, context):
        ...
        vtex_path = "D:\Steam\steamapps\common\Counter-Strike Global Offensive/bin/"
        ...
        os.chdir(vtex_path)
        os.system('start vtex_quick.lnk -outdir "D:\Steam\steamapps\common\Counter-Strike Global Offensive\csgo\materials\moderntech" -nopause %s' % (img_path))
        ...
        #    vtex_path,
        #    "-outdir 'D:\Steam\steamapps\common\Counter-Strike Global Offensive\csgo\materials\moderntech'",
        #    "-nopause",
        #    img_path
        #])
        #vtex.communicate()
...
# vtex_quick.lnk -outdir "D:\Steam\steamapps\common\Counter-Strike Global Offensive\csgo\materials\moderntech"  -nopause D:\Documents\BBBLEND\ModernParkMap\textures/Stand.tga
...
class VMT_PT_VMTPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(context.scene.qcgen, 'customimagedirectory')
